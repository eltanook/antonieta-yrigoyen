          ...
          <div className="flex flex-col h-full">
            ...
            <ScrollArea className="flex-1 -mx-6 px-6">
              <div className="space-y-3 py-4">
                {cartItems.map((item) => (
                  <div key={item.id} className="flex gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-slate-800">
            ...
            {/* Cart Summary */}
            <div className="border-t pt-4 space-y-4 bg-white dark:bg-slate-800">
