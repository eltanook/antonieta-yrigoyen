...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transform active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-[#00473E] text-white shadow-lg hover:shadow-xl hover:bg-[#00473E] hover:scale-105 border-0 rounded-full",
        destructive:
        ...
        outline:
          "border-2 border-[#00473E] bg-white/95 backdrop-blur-sm text-[#00473E] hover:bg-[#00473E] hover:border-[#00473E] hover:shadow-lg hover:scale-105 rounded-full shadow-md dark:text-[#00473E] dark:hover:bg-[#00473E]/20 dark:bg-gray-900/95",
        "outline-white":
          "border-2 border-white/60 bg-[#00473E]/20 backdrop-blur-md text-white hover:bg-[#00473E]/40 hover:border-white/80 hover:shadow-lg hover:scale-105 rounded-full shadow-lg",
        secondary:
        ...
        ghost: "text-white hover:bg-[#00473E] hover:text-white rounded-full backdrop-blur-sm",
        ...
        elegant: "bg-[#00473E] text-white shadow-xl hover:shadow-2xl hover:scale-105 hover:bg-[#00473E] border-0 rounded-full backdrop-blur-sm",
      },
      size: {
