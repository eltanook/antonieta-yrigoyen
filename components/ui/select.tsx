...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Value
    ref={ref}
    className={cn(
      "block truncate pr-6", // Evita superposición y recorta texto largo
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  ...
  <SelectPrimitive.ItemText className="truncate w-full block">{children}</SelectPrimitive.ItemText>
  </SelectPrimitive.Item>
))
